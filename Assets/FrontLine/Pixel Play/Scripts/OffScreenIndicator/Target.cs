...
public class Target : MonoBehaviour
{
    ...
    [SerializeField] private bool needOffScreenIndicator = true;

    [Tooltip("Select if arrow indicator is required for this target")]
    [SerializeField] private bool needOnscreenIndicator = true;
    ...
    /// </summary>
    public bool NeedOffScreenIndicator
    {
        get
        {
            return needOffScreenIndicator;
        }
    }
    ...
    /// </summary>
    public bool NeedOnScreenIndicator
    {
        get
        {
            return needOnscreenIndicator;
        }
    }
